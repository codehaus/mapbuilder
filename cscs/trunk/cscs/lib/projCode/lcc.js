...
Proj4js.Proj.lcc = {
  init : function() {
    ...
    // Standard Parallels cannot be equal and on opposite sides of the equator
      ...
      var ms1 = Proj4js.const.msfnz(this.e, sin1, cos1);
      var ts1 = Proj4js.const.tsfnz(this.e, this.lat1, sin1);

      var sin2 = Math.sin(this.lat2);
      var cos2 = Math.cos(this.lat2);
      var ms2 = Proj4js.const.msfnz(this.e, sin2, cos2);
      var ts2 = Proj4js.const.tsfnz(this.e, this.lat2, sin2);

      var ts0 = Proj4js.const.tsfnz(this.e, this.lat0, Math.sin(this.lat0));
    ...
    // convert to radians
      ...
      var con  = Math.abs( Math.abs(lat) - Proj4js.const.HALF_PI);
      var ts;
      if (con > Proj4js.const.EPSLN) {
        ts = Proj4js.const.tsfnz(this.e, lat, Math.sin(lat) );
  ...
  inverse : function(p) {
    ...
    if ((rh1 != 0) || (this.ns > 0.0)) {
      ...
      lat = Proj4js.const.phi2z(this.e, ts);
