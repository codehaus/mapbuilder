  ...
  OpenLayers.Class.inherit( OpenLayers.Control, {
   ...
   /* setMap: function(map) {
    ...
    _addButton:function(tool , xy) {
    	if(tool.type=="radioButton"){
        	var imgLocation = OpenLayers.Util.getImagesLocation() + tool.imageOff;
       		var activeImgLocation = OpenLayers.Util.getImagesLocation() + tool.imageOn;
        		}
		else if(tool.type=="button"){
    ...
    _swapButtonImg: function(tool, active){
            ...
            if (this.buttons[tool.id]) {
            	if (active=="off")
            		this.buttons[tool.id].firstChild.src=OpenLayers.Util.getImagesLocation() + tool.imageOff;
            	if (active=="on")
            		this.buttons[tool.id].firstChild.src=OpenLayers.Util.getImagesLocation() + tool.imageOn;
            }
