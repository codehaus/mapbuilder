...
//	this.targetModel.namespace = "xmlns:mb='http://mapbuilder.sourceforge.net/mapbuilder' xmlns:wmc='http://www.opengis.net/context' xmlns:xsl='http://www.w3.org/1999/XSL/Transform'";
    ...
    this.stylesheet = new XslProcessor(styleUrl);
  	...
  	this.changeFill = function(xpath,choix)
  	{
	...
	case '2' :this.model.setXpathValue(this.model,xpath+"/CssParameter[@name='stroke-linejoin']","Stroke",false);
  	...
  	default: return;
  	 ...
  	 this.mode = function(element,maxi,mini,titlerule,nbclass,mode,Cmin,Cmax)
  	 {
  	   ...
  	   break;
  	   case '3': this.symbolecouleur(element,maxi,mini,titlerule,nbclass,Cmin,Cmax);
  	   break;
  	   default:return;
  	   }
 ...
 this.DecToHex = function(dec){ return ((hex=dec.toString(16).toUpperCase()).length<2)?"0"+hex:hex; }
 this.HexToDec = function(hex){ return parseInt(hex,16); }
...
this.symbolecouleur = function(element,maxi,mini,titlerule,nbclass,Cmin,Cmax)
		{
		...
		javascript:config.objects.editSLD.createelementSLD(element,temp,mini,titlerule+i,color);
  	 ...
  	 this.symbole = function(element,maxi,mini,titlerule,nbclass)
		...
		javascript:config.objects.editSLD.createelementSLD(element,temp,mini,titlerule+i,'#CCFF00');
...
sld.firstChild.nodeValue=titlerule;
 ...
 sld.appendChild(v);
	...
	this.model.setXpathValue(this.model,xpath2+"/Stroke/CssParameter[@name=\'stroke\']","#CCFF66",false);
  	...
  	this.createelementSLD = function(element,up,low,titlerule,color){
...
sld.firstChild.nodeValue=titlerule;
 ...
 sld.appendChild(v);
	...
	this.model.setXpathValue(this.model,xpath2+"/PolygonSymbolizer/Fill/CssParameter",color,false);
	this.model.setXpathValue(this.model,xpath2+"/PolygonSymbolizer/Stroke/CssParameter[@name=\'stroke-width\']","1",false);
	this.model.setXpathValue(this.model,xpath2+"/PolygonSymbolizer/Stroke/CssParameter[@name=\'stroke\']",color,false);
