...
$Id: Proj.js 2211 2006-10-07 20:44:09Z rgreenwood $
*/
...
//      break;
    ...
    case "EPSG:27582"://LAMB2 IGN-F modification (deprecated) FD 2005
      ...
      this.title = "Lambert Conformal Conic";
      break;
    case "EPSG:27563":case new String("http://www.opengis.net/gml/srs/epsg.xml#27563").toUpperCase()://LAMB3 IGN-F modification FD 2005
      this.Init = lccinit;
      this.Forward = ll2lcc;
      this.Inverse = lcc2ll;
