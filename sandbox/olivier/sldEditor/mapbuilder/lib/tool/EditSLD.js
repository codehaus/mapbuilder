...
*
* @param  [legenType] [user choose a type of legend ]
* 
*
*/
...
this.styleOfStoke = function(titlerule,choosen)
{
...
this.mode = function(element,maxi,mini,titlerule,nbclass,mode,Cmin,Cmax)
{
  ...
  switch(mode)
  {
    ...
    break;
    case '2': 
    this.createRule(titlerule,typeofFeature,Cmin)
