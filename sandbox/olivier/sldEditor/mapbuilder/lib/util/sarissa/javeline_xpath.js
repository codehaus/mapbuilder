...
var _$ = function(tag, doc, prefix, force){
	if(_SARISSA_IS_OPERA && !prefix) return (doc || document).getElementsByTagName(tag);
	return (doc || document).getElementsByTagName((prefix && (force || _SARISSA_IS_MOZ) ? prefix + ":" : "") + tag);
}
