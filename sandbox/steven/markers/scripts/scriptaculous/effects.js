...
var Effect = {
  ...
  PAIRS: {
    ...
    'appear': ['Appear','Fade'],
    'slider': ['SlideRightIntoView','SlideRightOutOfView']
  },
...
Object.extend(Object.extend(Effect.Scale.prototype, Effect.Base.prototype), {
  ...
  setup: function() {
    ...
    this.originalStyle = {};
    ['top','left','width','height','fontSize','marginRight'].each( function(k) {
...
Effect.SlideRightIntoView = function(element) {
	map = document.getElementById("mainMapPane");
//	$(map).morph('left:20em');
//	$(map).morph('marginRight:20em');
...
//  $(map).style.marginRight = '20em';
}

Effect.SlideRightOutOfView = function(element) {
	map = document.getElementById("mainMapPane");
 // $(map).style.left = '20em';
 // $(map).style.marginRight = '0em';
	//$(map).morph('marginRight:0em');  
	//$(map).morph('left:0em');
