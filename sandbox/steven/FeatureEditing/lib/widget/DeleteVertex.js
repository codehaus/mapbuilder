...
$Id: DeleteVertex.js 2133 2006-06-22 15:28:52Z steven $
*/
...
/**
 * When this button is selected, click on a vertex to delete it
 * @constructor
 * @base ButtonBase
...
function DeleteVertex(widgetNode, model) {
  ...
  /**
   * Set or unset the delpoint parameter to let WfsQueryLayer 
   * know that vertices should be deleted when clicked
