...
$Id: DragPanHandler.js 1885 2006-01-28 18:55:28Z steven $
*/
  ...
  this.mouseUpHandler = function(objRef,targetNode) {
    if (objRef.enabled) {
      if (objRef.dragging) {
        ...
        //var offsetLeft = targetNode.lastChild.firstChild.offsetLeft;
       // var offsetTop = targetNode.lastChild.firstChild.offsetTop;
        //objRef.deltaP=objRef.deltaP+offsetLeft;
      //          objRef.deltaL=objRef.deltaL+offsetT;
