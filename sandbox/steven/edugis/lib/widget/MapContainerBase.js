...
$Id: MapContainerBase.js 2136 2006-06-22 16:19:12Z steven $
*/
 ...
 */
    ...
    //Enable fixed scales
    if (this.zoomLevels) this.containerModel.extent.setFixedScale(true,this.zoomLevels);
    else this.containerModel.extent.setFixedScale(false);
